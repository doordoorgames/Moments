...
export const api = {
    ...
    adminRambleTranscribe: (storyId, blob) => {
        ...
        return axios.post(`${API_BASE}/admin/ramble/transcribe`, body, {
            headers: adminHeaders(), timeout: 150000,
        }).then((r) => r.data);
    },
    adminRambleInterpret: (payload) =>
        axios.post(`${API_BASE}/admin/ramble/interpret`, payload, {
            headers: adminHeaders(), timeout: 120000,
        }).then((r) => r.data),
    adminRambleApply: (payload) =>
        axios.post(`${API_BASE}/admin/ramble/apply`, payload, {
            headers: adminHeaders(), timeout: 120000,
        }).then((r) => r.data),
};
